...
const OrderScreen = () => {
	...
	if (!loading) {
		order.itemsPrice = order&& order.orderItems.reduce(
				...
				<Grid templateColumns='3fr 2fr' gap='20'>
					...
					<Flex direction='column'>
						...
						<Box borderBottom='1px' py='6' borderColor='gray.300'>
							...
							<Text mt='4'>
								{order.isPaid ? (
									<Message type='success'>Paid on {order.paidAt.substring(0,10)}</Message>
								) : (
							...
							<Box>
								{loadingPay ? (
									...
									<PayPalScriptProvider
										options={{
											'client-id': 'AVU7GEC2KOnJO06JaY4OvO9mIdD1KNyxZy6s_KS_mvrJyfyerfhHktM3jHCzgTwh_AeOUKmhd4NSdlxz',
											components: 'buttons',
										}}>
										<PayPalButtons
